...
if (PAYPAL.apps = PAYPAL.apps || {}, function() {
        ...
        var a = {
            ...
            strings: {
                ...
                subtotal: "Subtotal: ",
                discount: "Discount: ",
                shipping: "Major Credit Cards Accepted",
        ...
        if (!PAYPAL.apps.MiniCart) {
            PAYPAL.apps.MiniCart = function() {
                var d = {},
                    ...
                    j = function() {
                        var b, c, d = a.name, e = [];
                        e.push("#" + d + " form { position:fixed; float:none; top:-250px; " + a.displayEdge + ":" + a.edgeDistance + "; width:500px; margin:0; padding:50px 10px 0; background:#fff url(" + a.assetURL + "images/minicart_sprite.png) no-repeat -125px -60px; border:1px solid #999; border-top:0; font:13px/normal arial, helvetica; color:#333; text-align:left; -moz-border-radius:0 0 8px 8px; -webkit-border-radius:0 0 8px 8px; border-radius:0 0 8px 8px; -moz-box-shadow:1px 1px 1px rgba(0, 0, 0, 0.1); -webkit-box-shadow:1px 1px 1px rgba(0, 0, 0, 0.1); box-shadow:1px 1px 1px rgba(0, 0, 0, 0.1); } "), 
                        e.push("#" + d + " ul { position:relative; overflow-x:hidden; overflow-y:auto; height: auto; margin:0 0 7px; padding:0; list-style-type:none; border-top:1px solid #ccc; border-bottom:1px solid #ccc; } "), e.push("#" + d + " li { position:relative; margin:-1px 0 0; padding:6px 5px 6px 0; border-top:1px solid #f2f2f2; } "), 
                        e.push("#" + d + " li a { display: block; width: 400px; color:#b44; text-decoration:none; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; } "), 
                        e.push("#" + d + " li a span { display:none; color:#999; font-size:10px; } "), 
                        e.push("#" + d + " li .quantity { visibility: collapse; position:absolute; top:.5em; right:78px; width:22px; padding:1px; border:1px solid #83a8cc; text-align:right; } "), 
                        ...
                        c = document.getElementsByTagName("head")[0], c.appendChild(b)
                    },
                    k = function() {
                    ...
                    l = function() {
                        var b, f, h, i = d.UI;
                        for (b = document.getElementsByTagName("form"), h = 0; h < b.length; h++) f = b[h], f.cmd && g[f.cmd.value] && d.bindForm(f);
                    ...
                    n = function() {
                        var a, b, d;
                        if (a = c.storage.load())
                            for (b = a.length, d = 0; b > d; d++) r(a[d]) && (e = !0)
                    },
                    o = function(a) {
                        var b, d, e, f, g = a.elements,
                            h = {};
                        for (e = 0, f = g.length; f > e; e++) b = g[e], (d = c.util.getInputValue(b)) && (h[b.name] = d);
                        return h
                    },
                    p = function(b) {
                        var c, e, f, g, h, j, k, l = {},
                        ...
                        for (l.href = l.href || window.location.href, l.quantity = l.quantity || 1, l.amount = l.amount || 0, m["return"] && -1 === m["return"].indexOf("#") && (m["return"] += "#" + a.name + "=reset"), e = l.option_index ? l.option_index : 0; l["os" + e];) {
                            for (j = 0;
                                "undefined" != typeof l["option_select" + j];) {
                    ...
                    r = function(a) {
                        ...
                        }), h.itemList.insertBefore(j.liNode, h.itemList.firstChild), c.util.animate(j.liNode, "opacity", {
                            from: 0,
                            to: 1
                        }), !0
                    },
                    s = function(b, e) {
                        ...
                        ("function" != typeof g || g.call(d, b) !== !1) && (b.setQuantity(0), b.quantityInput.style.display = "none", c.util.animate(b.liNode, "opacity", {
                            ...
                            c.util.animate(b.liNode, "height", {
                                ...
                                var c, e, f, g, i, j, k = d.UI.cart.getElementsByTagName("li"),
                                    l = k.length,
                                    m = 1;
                                for (i = 0; l > i; i++) {
                                    for (c = k[i].getElementsByTagName("input"), e = c.length, j = 0; e > j; j++) f = c[j], g = /(.+)_[0-9]+$/.exec(f.name), g && g[1] && (f.name = g[1] + "_" + m);
                                    m++
                                }
                    ...
                    t = function(b) {
                        ...
                        return "function" == typeof c && c.call(d, b) === !1 ? void b.preventDefault() : void(d.UI.button.value = a.strings.processing)
                    };
                return d.products = [], d.UI = {}, d.render = function(b) {
                    ...
                    var a, b, c, e, f, g, h = 0,
                        i = d.products;
                    for (g = 0, f = i.length; f > g; g++) b = i[g], (a = b.product) && a.quantity && a.amount && (c = a.amount, e = b.getDiscount(), h += parseFloat(c * a.quantity - e));
                    return h.toFixed(2)
                }, d.updateSubtotal = function(a) {
                    var b, e, f, g, h, i = d.UI,
                        j = i.cart.elements,
                        k = i.subtotalAmount,
                    ...
                    c.util.setText(k, c.util.formatCurrency(l, b)), a || ! function n() {
                        return f = m.toString(16), m++, k.style.backgroundColor = "#ff" + f, m >= 15 ? (k.style.backgroundColor = "transparent", void("0.00" === l && d.reset())) : void setTimeout(n, 30)
                    }()
                }, d.show = function(b) {
                    var f = parseInt(d.UI.cart.offsetTop, 10),
                        ...
                        i = h.onShow,
                        j = h.afterShow;
                    b && b.preventDefault && b.preventDefault(), ("function" != typeof i || i.call(d, b) !== !1) && (c.util.animate(d.UI.cart, "top", {
                        from: f,
                        to: g
                    }, function() {
                    ...
                    var g, h = d.UI,
                        ...
                        o = n.onHide,
                        p = n.afterHide;
                    g = f || 0 === d.products.length || !a.peekEnabled ? -1 * k : -1 * (k - l - 8), b && b.preventDefault && b.preventDefault(), ("function" != typeof o || o.call(d, b) !== !1) && (c.util.animate(i, "top", {
                        from: m,
                        to: g
                    }, function() {
            ...
            b.prototype = {
                _view: function(a, b) {
                    var d, e, f, g, h, i, j;
                    if (this.product = a.product, this.settings = a.settings, this.liNode = document.createElement("li"), this.nameNode = document.createElement("a"), this.metaNode = document.createElement("span"), this.discountNode = document.createElement("span"), this.discountInput = document.createElement("input"), this.priceNode = document.createElement("span"), this.quantityInput = document.createElement("input"), this.removeInput = document.createElement("input"), !this.product || !this.product.item_name && !this.product.item_number) return void(this.isPlaceholder = !0);
                ...
                getOptions: function() {
                    for (var a = {}, b = 0;
                        "undefined" != typeof this.product["on" + b];) a[this.product["on" + b]] = this.product["os" + b], b++;
                    return a
                },
            ...
            c.storage = function() {
                ...
                return window.localStorage ? {
                    load: function() {
                        ...
                        return e && (e = JSON.parse(decodeURIComponent(e))), e && e.expires && (a = new Date, d = new Date(e.expires), a > d) ? void c.storage.remove() : e && e.value ? e.value : e
                    },
                    save: function(a, c) {
                        var d, e, f, g, h = new Date,
                            i = [];
                        if (a) {
                            for (g = 0, f = a.length; f > g; g++) e = a[g], i.push({
                                product: e.product,
                                settings: e.settings
                            });
                            h.setTime(h.getTime() + 24 * c * 60 * 60 * 1e3), d = {
                                value: i,
                    ...
                    save: function(b, c) {
                        var d, e, f, g = new Date,
                            h = [];
                        if (b) {
                            for (f = 0, e = b.length; e > f; f++) d = b[f], h.push({
                                product: d.product,
                                settings: d.settings
                            });
                            g.setTime(g.getTime() + 24 * c * 60 * 60 * 1e3), document.cookie = a.name + "=" + encodeURIComponent(JSON.stringify(h)) + "; expires=" + g.toGMTString() + "; path=" + a.cookiePath
                        }
                    },
                    remove: function() {
                        this.save(null, -1)
                ...
                return document.addEventListener ? {
                    ...
                    remove: function(b, c, d) {
                        ...
                        for (g = 0; h > g; g++) f = a[g], f[0] === b && f[1] === c && f[2] === d && (e = f[3], e && (b.removeEventListener(c, e, !1), delete a[g]))
                    }
                    ...
                    remove: function(b, c, d) {
                        var e, f, g, h = a.length;
                        for (g = 0; h > g; g++) f = a[g], f[0] === b && f[1] === c && f[2] === d && (e = f[3], e && (b.detachEvent("on" + c, e), delete a[g]))
                    }
                } : void 0
            }(), c.util = {
                animate: function(a, b, c, d) {
                    ...
                    var e = (c.to - c.from) / 20,
                        f = c.from;
                    ! function g() {
                        return a.style[b] = f + c.unit, f += e, e > 0 && f > c.to || 0 > e && f < c.to || 0 === e ? (a.style[b] = c.to + c.unit, void("function" == typeof d && d())) : void setTimeout(g, c.duration)
                    }()
                },
...
PAYPAL.apps = PAYPAL.apps || {},
    function(a) {
        ...
        function c(b, c) {
            var d, e, f, i, j, k, m, n, o, p, q = a.createElement("form"),
                r = a.createElement("button"),
                s = a.createElement("input"),
                t = b.items;
            q.method = "post", q.action = h.replace("{env}", b.items.env.value), q.className = "paypal-button", q.target = "_top", s.type = "hidden", k = t.size && t.size.value || "large", m = t.lc && t.lc.value || "en_US", n = l[m] || l.en_US, p = n[c], b.items.text && (p = b.items.text.value, b.remove("text"));
            //t = items
            for (j in t) 
              d = t[j], 
              d.isEditable ? (i = a.createElement("input"), 
                              i.type = "text", 
                              i.className = "paypal-input", 
                              i.name = d.key, 
                              i.value = d.value, 
                              f = a.createElement("label"), 
                              f.className = "paypal-label", 
                              f.appendChild(a.createTextNode(g.config.labels[d.key] || n[d.key])), 
                              f.appendChild(i), 
                              e = a.createElement("p"), 
                              e.className = "paypal-group", 
                              e.appendChild(f)) 
                           : (i = e = s.cloneNode(!0), 
                              i.name = d.key, 
                              i.value = d.value),
            ...
            return r.className = "paypal-button " + k, r.appendChild(a.createTextNode(p)), q.appendChild(r), (o = PAYPAL.apps.MiniCart) && "_cart" === b.items.cmd.value && (o.UI.itemList || o.render(), o.bindForm(q)), q
        }

        function d(b, c) {
            var d, e, f = h.replace("{env}", b.items.env.value),
        ...
        function e(a) {
            var b, c, d, e, f, g = {};
            if (b = a.attributes)
                for (f = 0, e = b.length; e > f; f++) c = b[f], (d = c.name.match(/^data-([a-z0-9_]+)(-editable)?/i)) && (g[d[1]] = {
                    value: c.value,
                    isEditable: !!d[2]
                });
            return g
        ...
        if (PAYPAL.apps.ButtonFactory || (g.config = {
                ...
                var i, l, m, n = new f;
                if (!a) return !1;
                for (l in e) n.add(k[l] || l, e[l].value || e[l], e[l].isEditable);
            ...
            var m, n, o, p, q, r, s = PAYPAL.apps.ButtonFactory,
